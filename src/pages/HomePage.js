  ...
  return (
    <div className="min-h-screen">
              ...
              <div className="aspect-w-16 aspect-h-9">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/20">
                  <div className="absolute inset-0 flex flex-col justify-end p-8">
                    <h3 className="text-2xl font-bold text-white mb-2">Latest Phones</h3>
                    <p className="text-gray-200 mb-4">Discover our collection of premium smartphones</p>
                    <Link
                      to="/phones/iphone"
                      className="text-white border border-white px-6 py-2 rounded-full hover:bg-white hover:text-black transition-colors inline-block"
                    >
                      Explore
                    </Link>
                  </div>
              ...
              <div className="aspect-w-16 aspect-h-9">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/20">
                  <div className="absolute inset-0 flex flex-col justify-end p-8">
                    ...
                    <p className="text-gray-200 mb-4">Essential accessories for your devices</p>
                    <Link
                      to="/accessories/charging-cables"
                      className="text-white border border-white px-6 py-2 rounded-full hover:bg-white hover:text-black transition-colors inline-block"
                    >
              ...
              <div className="aspect-w-16 aspect-h-9">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/20">
                  <div className="absolute inset-0 flex flex-col justify-end p-8">
                    ...
                    <p className="text-gray-200 mb-4">Professional repair and maintenance services</p>
                    <Link
                      to="/services/repair"
                      className="text-white border border-white px-6 py-2 rounded-full hover:bg-white hover:text-black transition-colors inline-block"
                    >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Why Choose Mehta Telecom?</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-blue-500 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">Quick delivery and repair services</p>
            </div>
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-blue-500 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">Professional technical assistance</p>
            </div>
          </div>
        </div>
      </section>
